...
@Component({
  selector: 'app-customer-issue-bill-print',
  templateUrl: './customer-issue-bill-print.component.html',
  styleUrls: ['./customer-issue-bill-print.component.scss']
})
export class CustomerIssueBillPrintComponent {
