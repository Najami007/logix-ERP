...
@Component({
  selector: 'app-customer-issuance',
  templateUrl: './customer-issuance.component.html',
  styleUrls: ['./customer-issuance.component.scss']
})
export class CustomerIssuanceComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.global.setHeaderTitle('Customer Issuance');
    this.getLocation();
    this.getPartyList();
