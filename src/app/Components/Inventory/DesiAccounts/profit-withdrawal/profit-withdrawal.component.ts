...
@Component({
  selector: 'app-profit-withdrawal',
  templateUrl: './profit-withdrawal.component.html',
  styleUrls: ['./profit-withdrawal.component.scss']
})
export class ProfitWithdrawalComponent {
  ...
  addPayment(){
    this.dialogue.open(AddWithdrawalComponent,{
      width:'30%',
  ...
  getSavedData(){
    this.http.get(environment.mainApi+this.globaldata.accountLink+'GetPayRec?reqType=PRO').subscribe(
      (Response:any)=>{
