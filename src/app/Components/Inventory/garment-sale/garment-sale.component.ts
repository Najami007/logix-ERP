...
export class GarmentSaleComponent implements OnInit {
            ...
            this.global.getProdDetail(0, barcode).subscribe(
              (Response: any) => {
                ...
                this.tableDataList.push({
                  ...
                  aq: Response[0].aq,
                  total:Response[0].salePrice * qty,
  ...
  getTotal() {
    ...
    this.tableDataList.forEach((e: any) => {
      ...
      e.total = e.salePrice * e.quantity;
  ...
  editDiscR(amount: any) {
    this.tableDataList[this.tableDataList.indexOf(this.tempProdData)].discInR = amount;
  ...
  editDiscP(amount: any) {
    this.tableDataList[this.tableDataList.indexOf(this.tempProdData)].discInP = amount;
    this.tableDataList[this.tableDataList.indexOf(this.tempProdData)].discInR = (this.tableDataList[this.tableDataList.indexOf(this.tempProdData)].salePrice * amount) / 100;
  ...
  editTotal(amount:any){
    ...
    this.tableDataList[this.tableDataList.indexOf(this.tempProdData)].quantity = (amount / this.tableDataList[this.tableDataList.indexOf(this.tempProdData)].salePrice);
