...
@Component({
  selector: 'app-whs-saved-bill',
  templateUrl: './whs-saved-bill.component.html',
  styleUrls: ['./whs-saved-bill.component.scss']
})
export class WhsSavedBillComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<WhsSavedBillComponent>,
