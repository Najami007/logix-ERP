...
@Component({
  selector: 'app-whole-sale-return',
  templateUrl: './whole-sale-return.component.html',
  styleUrls: ['./whole-sale-return.component.scss']
})
export class WholeSaleReturnComponent implements OnInit {
