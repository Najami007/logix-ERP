...
@Component({
  selector: 'app-garment-rtn-saved-bill',
  templateUrl: './garment-rtn-saved-bill.component.html',
  styleUrls: ['./garment-rtn-saved-bill.component.scss']
})
export class GarmentRtnSavedBillComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<GarmentRtnSavedBillComponent>,
