...
@Component({
  selector: 'app-vrtnsavedbill',
  templateUrl: './vrtnsavedbill.component.html',
  styleUrls: ['./vrtnsavedbill.component.scss']
})
export class VrtnsavedbillComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<VrtnsavedbillComponent>,
