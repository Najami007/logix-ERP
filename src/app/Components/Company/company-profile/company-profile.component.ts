...
export class CompanyProfileComponent implements OnInit {
  ...
  save() {
    ...
    // if (this.CompanyMobile == '' || this.CompanyMobile == undefined) {
    //   this.msg.WarnNotify('Enter Company Mobile No');
    //   return;
    // }
    // if (this.CompanyPhone == '' || this.CompanyPhone == undefined) {
    //   this.msg.WarnNotify('Enter Phone No.');
    //   return;
    // }
    // if (this.CompanyEmail == '' || this.CompanyEmail == undefined) {
    //   this.msg.WarnNotify('Enter Company Email Address');
    //   return;
    // }
    // if (this.CompanyAddress == '' || this.CompanyAddress == undefined) {
    //   this.msg.WarnNotify('Enter Company Address');
    //   return;
    // }
    if (this.CompanyLogo1 == '' || this.CompanyLogo1 == undefined && this.btnType == 'Save') {
      this.msg.WarnNotify('Select LOGO 1');
      return;
    }
    if (this.Logo1Height == '' || this.Logo1Height == undefined && this.btnType == 'Save') {
      this.msg.WarnNotify('Enter LOGO 1 Height');
      return;
    }
    if (this.Logo1Width == '' || this.Logo1Width == undefined && this.btnType == 'Save') {
      this.msg.WarnNotify('Enter LOGO 1 Width');
      return;
    }
    //  if (this.NTNNo == '' || this.NTNNo == undefined) {
    //   this.msg.WarnNotify('Enter NTN NO');
    //   return;
    // } 

    //  if (this.STRNNo == '' || this.STRNNo == undefined) {
    //   this.msg.WarnNotify('Enter STRN No.');
    //   return;
    // } 
    //  if (this.RegistrationDate == '' || this.RegistrationDate == undefined) {
    //   this.msg.WarnNotify('Enter Registration Date');
    //   return;
    // } 
    //  if (this.RegistrationNo == '' || this.RegistrationNo == undefined) {
    //   this.msg.WarnNotify('Enter Registration No.');
    //   return;
    // } 
    if (this.CompanyLogo3 !== '' && (this.CompanyLogo2 == '')) {
      this.msg.WarnNotify('Select Logo 2 First');
      return;
    }
    if ((this.CompanyLogo2 !== '') && (this.Logo2Height == '' || this.Logo2Height == 0 || this.Logo2Width == 0 || this.Logo2Width == '')) {
      //  alert(this.CompanyLogo2);
      this.msg.WarnNotify('Enter Logo 2 Height & Width');
      return;
    }
    if (this.CompanyLogo3 !== '' && (this.Logo3Height == '' || this.Logo3Height == 0 || this.Logo3Width == 0 || this.Logo3Width == '')) {
    ...
    if (this.btnType == 'Save') {
      this.insertCompany(postData);
    } else if (this.btnType == 'Update') {
      this.global.openPinCode().subscribe(pin => {
        if (pin != '') {
          this.updateCompany(pin, postData);
        }
  ...
  insertCompany(postData: any) {
    this.app.startLoaderDark();
    this.http.post(environment.mainApi + this.global.companyLink + 'insertcp', postData).subscribe(
      (Response: any) => {
  ...
  updateCompany(pin: any, postData: any) {
    this.app.startLoaderDark();
    postData['Pincode'] = pin;
    postData.CompanyAlias = 'Update';
    this.http.post(environment.mainApi + this.global.companyLink + 'updatecp', postData).subscribe(
      (Response: any) => {
