...
@Component({
  selector: 'app-add-contractor-profile',
  templateUrl: './add-contractor-profile.component.html',
  styleUrls: ['./add-contractor-profile.component.scss']
})
export class AddContractorProfileComponent implements OnInit {
