...
@Component({
  selector: 'app-opening-cash',
  templateUrl: './opening-cash.component.html',
  styleUrls: ['./opening-cash.component.scss']
})
export class OpeningCashComponent {
  ...
  ngOnInit(): void {
    this.globaldata.setHeaderTitle('Opening Cash');
    this.getSavedData();
  ...
  addPayment(){
    this.dialogue.open(AddOpeningComponent,{
      width:'30%',
